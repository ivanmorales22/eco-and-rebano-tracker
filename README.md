...
Repository created for the creation of an AI Agent, to keep myself up to date with the latest news about two of my main passions, sustainability and Chivas de Gudalajara. 
...
The solution comes with a bot that gathers the info, and display it on a Streamlit Dashboard.